...
@section('content')
    ...
    <h1>Consumers <a href="{{ url('/consumers/create') }}" class="btn btn-primary btn-xs" title="Add New Consumer"><span class="glyphicon glyphicon-plus" aria-hidden="true"/></a>
                <a href="{{ url('/consumers/printConsumers') }}" class="btn btn-info btn-xs" title="Print All Consumer"><span class="glyphicon glyphicon-print" aria-hidden="true"/></a>
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            @foreach($consumers as $item)
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ url('/consumers/' . $item->id) }}" class="btn btn-success btn-xs" title="View Consumer"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"/></a>
                        <a href="{{ url('/consumers/' . $item->id . '/edit') }}" class="btn btn-primary btn-xs" title="Edit Consumer"><span class="glyphicon glyphicon-pencil" aria-hidden="true"/></a>
                        @if(isset(Auth::user()->admin->user_id))
                            {!! Form::open([
                                'method'=>'DELETE',
                                'url' => ['/consumers', $item->id],
