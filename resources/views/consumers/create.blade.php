...
<div class="container">
    ...
    {!! Form::open(['url' => '/consumers', 'class' => 'form-horizontal upload-form', 'files'=>true]) !!}
            ...
            <div class="form-group {{ $errors->has('package_id') ? 'has-error' : ''}}">
                {!! Form::label('package_id', 'Package *', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
                    {!! Form::select('package_id', $packages->lists('name', 'id'), null, ['class' => 'form-control', 'required' => 'required']) !!}
            ...
            <div class="form-group {{ $errors->has('start_date') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::date('start_date', $today, ['class' => 'form-control', 'required' => 'required']) !!}
