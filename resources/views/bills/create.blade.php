...
@section('content')
    ...
    {!! Form::open(['url' => '/bills', 'class' => 'form-horizontal']) !!}
            ...
            <div class="form-group {{ $errors->has('generate_bill_id') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::select('generate_bill_id', $bill_generators->lists('name', 'id'), null, ['class' => 'form-control', 'placeholder' => 'Select Bill', 'required' => 'required']) !!}
