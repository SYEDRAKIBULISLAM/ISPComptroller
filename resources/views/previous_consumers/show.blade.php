...
@section('content')
    <div class="container">
        ...
        <h1>Previous Consumer {{ $consumer->id }}
            <a href="{{ url('previous_consumers/' . $consumer->id . '/edit') }}" class="btn btn-primary btn-xs" title="Edit Consumer"><span class="glyphicon glyphicon-pencil" aria-hidden="true"/></a>
