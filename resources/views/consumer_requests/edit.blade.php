...
@section('content')
    ...
    <h1>Edit Request {{ $consumer_request->id }}</h1>

    {!! Form::model($consumer_request, [
        'method' => 'PATCH',
    ...
    <hr/>
            ...
            <div class="form-group {{ $errors->has('consumer_id') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-6">
                    {!! Form::select('consumer_id', $consumer_request->consumer->lists('name', 'id'), null, ['class' => 'form-control', 'placeholder' => 'Select Consumer', 'required' => 'required']) !!}
