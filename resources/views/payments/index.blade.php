...
@section('content')
    ...
    <h1>Payments <a href="{{ url('payments/create') }}" class="btn btn-primary btn-xs" title="Add New Payment"><span class="glyphicon glyphicon-plus" aria-hidden="true"/></a>
    </h1>
    <hr/>
    <div class="">
        <div id="filter-panel" class="collapse filter-panel">
            <div class="panel panel-default">
                <div class="panel-body">
                    {!! Form::open(['url' => '/payments', 'class' => 'form-inline', 'method' => 'GET']) !!}
    ...
    <div class="table">
        <table class="table table-bordered table-striped table-hover">
            <thead>
                <tr>
                    <th>S.No</th><th> Consumer </th><th> Bill Name </th><th> Amount </th><th> Discount </th><th> Due </th><th> Date </th><th>Actions</th>
                </tr>
            </thead>
            <tbody>
        ...
        <div class="pagination-wrapper"> {!! $payments->appends(Request::only('rows'))->appends(Request::only('consumer'))->appends(Request::only('fromdate'))->appends(Request::only('todate'))->render() !!} </div>
    </div>
